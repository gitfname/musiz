...
// Description : this is the global store to managing the BottomSongController component ( that card appears at the bottom of the screen when you play a song )